...
// TDataPacket::TDataPacket(std::size_t _size) : data(nullptr)
// {
//   if (_size <= 0)
//   {
//     throw - 1;
...
// TDataPacket::TDataPacket(int* _data, int _size) : data(nullptr)
// {
...
// TDataPacket::TDataPacket(double* _data, int _size) : data(nullptr)
// {
//   if ((_size <= 0) || (_data == nullptr))
//   {
//     throw - 1;
...
// TDataPacket::TDataPacket(char* _data, int _size) : data(nullptr)
// {
//   if ((_size <= 0) || (_data == nullptr))
//   {
//     throw - 1;
